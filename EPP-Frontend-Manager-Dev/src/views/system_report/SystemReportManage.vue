        ...
        <el-collapse-item name="1">
            <template #title>
                <div class="collapse-title">
                    ...
                    <span class="collapse-title-text">自删除评论审核</span>
                </div>
            </template>
            <el-menu :default-active="$route.path" class="menu" mode="horizontal" :ellipsis="false" router>
                <el-menu-item class="menu-content" index="/report/unreverted">未恢复</el-menu-item>
                <el-menu-item class="menu-content" index="/report/reverted">已恢复</el-menu-item>
            </el-menu>
